document.addEventListener('DOMContentLoaded', function () {
    ...
    function initializeStudentArea() {
        ...
        uploadedImages.forEach((image, index) => {
            ...
            // Adiciona um número ao slot
            const numberLabel = document.createElement('span');
            numberLabel.textContent = index + 1; // Números começam de 1, não de 0
            numberLabel.classList.add('slot-number');
    ...
    slotsContainer.ondrop = function (event) {
        ...
        if (slot && !slot.querySelector('img')) { // Alterado para verificar se já contém uma imagem
